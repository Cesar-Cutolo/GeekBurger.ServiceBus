...
namespace GeekBurger.ServiceBus
{
    class Program
    {
        const string QueueConnectionString = "Endpoint=sb://geekburger1.servicebus.windows.net/;SharedAccessKeyName=ProductPolicy;SharedAccessKey=4MomvQwZ1jnhVC4XJZDBJYX+wAZQ+p2fmFKvKU22bR8=";
